...
const UsyncBotProfileProtocol_1 = require("mod-baileys/lib/WAUSync/Protocols/UsyncBotProfileProtocol");
const UsyncLIDProtocol_1 = require("mod-baileys/lib/WAUSync/Protocols/UsyncLIDProtocol");
const Protocols_1 = require("mod-baileys/lib/WAUSync/Protocols");
class USyncQuery {
    constructor() {
        this.protocols = [];
        this.users = [];
